...
public class GPUSkinningExportList : MonoBehaviour
{
    ...
    public void StartExport(GameObject[] prefabList, Action<GameObject> onComplete)
    {
        ...
        index = 0;
        runing = true;
        Debug.Log("StartExport " + prefabList.Length + ", runing=" + runing + "  onComplet=" + onComplete + "  Application.isPlaying=" + Application.isPlaying );
    ...
    void Start()
    {
        Debug.Log("Start  onComplet=" + onComplete);
    ...
    void Update()
    {
        ...
        if (!currentSampler.isSampling && !currentSampler.IsSamplingProgress())
        {
            ...
            if(index >= prefabList.Length)
            {
                ...
                StartCoroutine(DelayCallComplete());
    ...
    public IEnumerator DelayCallComplete()
    {
